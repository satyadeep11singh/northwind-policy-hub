...
// ── Ontario auto premium components (annual, CAD) ─────────────────────────────
const AUTO_RATES = {
...
// ── Ontario home premium components (annual, CAD) ─────────────────────────────
const HOME_RATES = {
  // base dwelling: $2.00 per $1,000 of replacement value
...
function calculatePremium(policyType, coverages) {
...
module.exports = { calculatePremium, calculateAutoPremium, calculateHomePremium };
